...
# 📃 Generates PDF from HTML with custom headers and footers with wkhtmltopdf v2025.4.148
...
`p3x-html-pdf` works seamlessly on Linux, Windows adn ARM64.
...
[**P3X-HTML-PDF**](https://corifeus.com/html-pdf) Build v2025.4.148
